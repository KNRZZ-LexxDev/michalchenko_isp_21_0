...
function show_navigation() {
    ...
    <div class="MainPage__Content">
        ...
        <div class="MainPage__Content-Link-Wrap">
            ...
            <div class="MainPage__Content-Lab-Wrap">
                <a href="src/page/generate-daily.php" class="MainPage__Content-Link-Head">Generate Image</a>
                <p class="MainPage__Content-Link-Desc">Side Quest for Lab9</p>
            </div>

            <div class="MainPage__Content-Lab-Wrap">
                <a href="src/page/generate-show.php" class="MainPage__Content-Link-Head">Show Images</a>
                <p class="MainPage__Content-Link-Desc">Side Quest Result</p>
            </div>

            <div class="MainPage__Content-Lab-Wrap">
                <a href="src/page/laba10.php" class="MainPage__Content-Link-Head">Messenger</a>
                <p class="MainPage__Content-Link-Desc">Lab 10</p>
            </div>
        </div>
